...
All prices USD per million tokens (MTok), verified 2026-09-21. Output is 5x input on every current tier. **Re-verify before quoting dollar figures — rates and availability change.**

| Model | Input | Output | Cache read |
|-------|-------|--------|------------|
| Haiku 4.5 (`claude-haiku-4-5`) | $1.00 | $5.00 | $0.10 (0.1x) |
| Sonnet 5 (`claude-sonnet-5`) | $2.00 | $10.00 | $0.20 (0.1x) |
| Opus 5 (`claude-opus-5`) | $5.00 | $25.00 | $0.50 (0.1x) |
| Fable 5.1 (`claude-fable-5-1`) | $10.00 | $50.00 | **$0.25 (0.025x)** |

Legacy, pinned but not routed to: Sonnet 4.6 $3/$15 · Opus 4.8 $5/$25 · Fable 5 $10/$50.
...
- Compare to running those 6 workers on Opus synchronously, uncached: 6 x (250 x $5 + 50 x $25) / 1e6 = $0.0150 — roughly **16x more** for the same grunt work.
